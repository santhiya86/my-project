...
function MenteeList() {
  ...
  // Define mentee lists for different mentors
  const menteeLists = {
    '101': [
      { id: 1, name: "Santhiya", department: "CSE", year: "III", section: "A" },
      { id: 2, name: "Koushika", department: "CSE", year: "III", section: "A" },
      { id: 3, name: "Kavitha", department: "CSE", year: "III", section: "B" },
      { id: 4, name: "Diruja", department: "CSE", year: "III", section: "B" }
    ],
    '102': [
      { id: 1, name: "Shivani Suresh", department: "CSE", year: "III", section: "A" },
      { id: 2, name: "Hemavathi", department: "CSE", year: "III", section: "A" },
      { id: 3, name: "Shapna", department: "CSE", year: "III", section: "B" },
      { id: 4, name: "Blessy", department: "CSE", year: "III", section: "B" }
    ],
    '103': [
      { id: 1, name: "Bhava Karni", department: "CSE", year: "III", section: "A" },
      { id: 2, name: "Balasanthosini", department: "CSE", year: "III", section: "A" },
      { id: 3, name: "Narmatha", department: "CSE", year: "III", section: "B" },
      { id: 4, name: "Jeyabharathi", department: "CSE", year: "III", section: "B" }
    ]
  };
